...
public class AdminAddNewProductActivity extends AppCompatActivity {
    private String CategoryName, Description, Price, Pdtname, saveCurrentDate, saveCurrentTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AddNewProductButton = (Button) findViewById(R.id.btnAddNewProduct);
    ...
    private void ValidateProductData()
    {
        ...
        Pdtname = InputProductName.getText().toString();
        ...
        {
            Toast.makeText(this, "Product description missing", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(Price))
        {
            Toast.makeText(this, "Product Price missing", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(Pdtname))
        {
            Toast.makeText(this, "Product name missing", Toast.LENGTH_SHORT).show();
        }
        else
        {
            StorePrdtInformation();
        }
    }



    private void StorePrdtInformation()
    {
        pb.setTitle("Add New Product");
        pb.setMessage("Dear Admin, please wait while we are adding the new product.");
    ...
    private void SaveProductInfoToDatabase()
    {
       ...
       productMap.put("pdtname", Pdtname);
